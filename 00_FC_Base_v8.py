...
selling_price_txt = "Selling Price: ${:.2f}".format(selling_price)
...
# Change frames to strings (so it can be written to a txt file)
...
to_write = [product_name_txt, "\n--- Variable Costs---", variable_txt,
            ...
            "\n---- Selling Advice ----", selling_price_txt, recommended_price_txt]
